...
set.seed(142)
png(paste("Topic_Modeling_tagged/Adj_tm_stopwords_1_topic/topic1-",
...
for (i in 1: 15){
  ...
  set.seed(142)
  png(paste("Topic_Modeling_tagged/Adj_tm_stopwords_15_topic/topic",
            i, "-",
            paste(topic.top.words$words[1],
                  topic.top.words$words[2],
                  topic.top.words$words[3],sep = "-"), ".png", sep = ""),
...
for (i in 1: 30){
  ...
  #Produce a word cloud of top words in a topic
  set.seed(142)
  png(paste("Topic_Modeling_tagged/Adj_tm_stopwords_30_topic/topic",
            i, "-",
            paste(topic.top.words$words[1],
                  topic.top.words$words[2],
                  topic.top.words$words[3],sep = "-"), ".png", sep = ""),
  ...
  wordcloud(topic.top.words$words,
            topic.top.words$weights,
            c(4,.5), rot.per=0, random.order=F, colors = rainbow(20))
  dev.off()
}
